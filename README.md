...
# Infrastructure
The infrastructure for this project consists of a web server, an automated VoIP system that dials users and prompts for authentication, a PBX for call routing, BGP routers for the core network, a WireGuard VPN for end user softphones, and an attacker machine to carry out our exploits.
